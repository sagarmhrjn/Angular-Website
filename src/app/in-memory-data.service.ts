...
export class InMemoryDataService implements InMemoryDbService {
  ...
  createDb() {
    const users = [
      { id: 11, firstName: 'Sagar', lastName: 'Maharjan', email: 'test123@gmail.com', password: 'welcome' },
      { id: 12, firstName: 'Rikee', lastName: 'Maharjan', email: 'test321@gmail.com', password: 'welcome' },
    ];
    return { users };
  }
